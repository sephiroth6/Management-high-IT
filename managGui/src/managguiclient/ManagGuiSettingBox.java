...
public class ManagGuiSettingBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(managguiclient.ManagGuiApp.class).getContext().getActionMap(ManagGuiSettingBox.class, this);
        closeButton.setAction(actionMap.get("closeSettingBox")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(managguiclient.ManagGuiApp.class).getContext().getResourceMap(ManagGuiSettingBox.class);
